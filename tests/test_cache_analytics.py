...
async def test_summary(client: AsyncClient):
    ...
    entries = [
        dict(
            ...
            cost=_compute_quota(1000, 200, 500, ir, or_, cir),
        ...
        dict(
            ...
            cached_completion_tokens=0,
            cost=_compute_quota(500, 100, 200, ir, or_, cir),
            content="ChatCompletion with deepseek-v4-flash",
            token_name="default", username="root",
        ),
        dict(
            ...
            cached_completion_tokens=0,
            cost=_compute_quota(300, 50, 0, ir, or_, cir),
            content="ChatCompletion with deepseek-v4-flash",
            token_name="default", username="root",
        ),
    ]
...
async def test_breakdown(client: AsyncClient):
    ...
    entries = [
        dict(
            ...
            cached_completion_tokens=0,
            cost=_compute_quota(100, 20, 50, 1.0, 2.0, 0.02),
            content="ChatCompletion with deepseek-v4-flash",
            token_name="default", username="root",
        ),
        dict(
            ...
            cached_completion_tokens=0,
            cost=_compute_quota(100, 20, 30, 3.0, 6.0, 0.025),
            content="ChatCompletion with deepseek-v4-pro",
            token_name="default", username="root",
        ),
        dict(
            ...
            cached_completion_tokens=0,
            cost=_compute_quota(200, 40, 100, 1.0, 2.0, 0.02),
            content="ChatCompletion with deepseek-v4-flash",
            token_name="default", username="root",
        ),
        dict(
            ...
            cached_completion_tokens=0,
            cost=_compute_quota(200, 40, 80, 3.0, 6.0, 0.025),
            content="ChatCompletion with deepseek-v4-pro",
            token_name="default", username="root",
        ),
    ]
...
async def test_filters(client: AsyncClient):
    ...
    entries = [
        ...
        dict(
            ...
            prompt_tokens=500, completion_tokens=100, cached_prompt_tokens=200,
            cached_completion_tokens=0,
            cost=_compute_quota(500, 100, 200, 1.0, 2.0, 0.02),
            content="ChatCompletion with deepseek-v4-flash",
            token_name="default", username="root",
        ),
    ]
